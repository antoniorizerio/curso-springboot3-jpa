...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), OrderStatusEnum.WAITING_PAYMENT, u2);
		...
		// Quando é uma relação de Dependencia, não se chama o repository do 
		// Payment, objeto que depende de Order. Basta adicionar ao objeto principal.
